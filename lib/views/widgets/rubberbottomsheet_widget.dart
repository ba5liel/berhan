...
import 'package:berhan/customize_existing_lib/modified_rubberbottomsheet.dart';
import 'package:berhan/views/pages/info_view.dart';
import 'package:berhan/views/pages/positioned.dart';
...
class RubberBottomSheetWidget extends StatefulWidget {
  ...
  RubberBottomSheetWidget({this.result, this.initialvalue});

  @override
  _RubberBottomSheetWidgetState createState() =>
      _RubberBottomSheetWidgetState();
}

class _RubberBottomSheetWidgetState extends State<RubberBottomSheetWidget>
...
// Here you can write your code
  ...
  Widget build(BuildContext context) {
    return ModifiedRubberBottomSheet(
      ...
      upperLayer:
          InfoView(result: widget.result), //_getBodyLayer(),
