...
import 'package:berhan/views/shared/app_colors.dart';
...
class _CustomCarousalSliderState extends State<CustomCarousalSlider> {
  List childlist;
  CarousalItemModel selecteditem =
      new CarousalItemModel(Icons.search, "Search");
      ...
      (index, i) {
        return GestureDetector(
          ...
          child: CircleAvatar(
            ...
            child: Icon(
              widget._iconlist[index].icondata,
              color: Colors.black,
            ),
          ),
        );
  ...
  void actionOnPageChange(CarousalSliderViewModel viewmodel, int index) {
    viewmodel.services.i_vibrate.vibrateForDurationInMilisecond(200);
